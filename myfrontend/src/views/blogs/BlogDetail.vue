<template>
  <div class="container is-widescreen">
    <section class="section" v-if="error">
      <div class="container is-widescreen">
        <div class="notification is-danger">{{ blogs.error.code }}: {{ blogs.error.sqlMessage }}</div>
      </div>
    </section>
            ...
            <div class="container">
              ...
              <div class="columns box">
                ...
                <div class="column is-2">
                  <a type="button" class="button is-link" value="submit" @click="submit()"
                    >submit</a
                  >
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      axios
        .post(`http://localhost:3000/blogs/${this.$route.params.id}`, formData, {
          headers: {
